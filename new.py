...
sitl = SITL('/home/kailash7/Desktop/Drone/apm/ardupilot/build/sitl/bin/') # load a binary path (optional)

sitl.download('copter', "3.3", verbose=True) # ...or download system (e.g. "copter") and version (e.g. "3.3")
